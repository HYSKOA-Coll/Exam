...
<!-- 头部导航 bg -->
      ...
      <ul class="nav-list pull-left clearfix">
              ...
              <li><a id="xsgl" href="${pageContext.request.contextPath}/teacher/studentm.jsp">学生管理</a></li>
              <li><a id="zygl" href="${pageContext.request.contextPath}/Taskp2/getTask_pack.action?pageNow=1">作业管理</a></li>
