	  ...
	  $.ajax({
			...
			success:function(resultData){
				...
				alert(resultData)
				 ...
				 window.location.href = "${pageContext.request.contextPath}/instance/selectPacket.action?plan_id="+plan_id+"&clazz_name="+clazz_name+"&plan_name="+plan_name+"&token="+resultData+"&clazz_id="+clazz_id;
