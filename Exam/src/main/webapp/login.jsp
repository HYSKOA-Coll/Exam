...
.body-box{ 
    ...
    background:url("img/start3.jpg") no-repeat top center;
	...
	function login(){
		...
		$.ajax({
			...
			success:function(resultData){
				...
				}else if(resultData == "teacher"){
					window.location.href = "${pageContext.request.contextPath}/teacher/home.jsp";
				}else if(resultData == "student"){
					window.location.href = "${pageContext.request.contextPath}/student/kt.jsp";
				}   
			}
