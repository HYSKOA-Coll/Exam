...
/* 回顾 */
/* function review(token,student_id){
	alert(token+"---"+student_id)
	
	   $.ajax({
			type:'POST',
			data:"token="+token+"&info_id="+student_id,
			url:'${pageContext.request.contextPath}/instanceAnswer/stuSelquestion.action',
			success:function(resultData){
			} 
		})  
} */
