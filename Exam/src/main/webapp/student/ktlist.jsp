  ...
  <table class="table table-hover" style="width: 94%;">
    ...
    <c:forEach items="${endlist.datas  }" var="list">
        <tr class="reclick">
            ...
            <td class="hidden-sm hidden-xs"><a href="${pageContext.request.contextPath}/instanceAnswer/stuSelquestion.action?token=${list.token}&info_id=${student_id }" <%-- onclick="review('${list.token}',${student_id })" --%>>回顾</a></td>
        </tr>
		</c:forEach>
        </tbody>
</table>
