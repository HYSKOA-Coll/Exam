...
import com.tao.dao.StudentlistMapper;
import com.tao.dao.StudentmanMapper;
import com.tao.dao.TaskMapper;
import com.tao.dao.Task_answerMapper;
import com.tao.dao.Task_executeMapper;
import com.tao.dao.Task_packageMapper;
...
public class BaseServiceImpl<T> implements BaseService<T> {
    ...
    @Autowired
    protected Task_executeMapper task_executeMapper;
    @Autowired
    protected TaskMapper taskMapper;
    @Autowired
    protected Task_packageMapper task_packageMapper;
    @Autowired
    protected Task_answerMapper task_answerMapper;
    @Autowired
    protected StudentmanMapper studentmanMapper;
    @Autowired
    protected StudentlistMapper studentlistMapper;
    @Autowired
    protected MarkingMapper markingMapper;
